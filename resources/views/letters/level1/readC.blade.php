...
<div class="container">
    <div class="Header">
        <a id="kembaliButton" href="bacaB.html">
        ...
        <div class="Objek">
            <button class="card" data-letter="A" onclick="playAudio('/assets/c.mp3')"> 
            <img src="/assets/Group 10.png" width="240" height="250" alt="Huruf A">
            </button>
        </div>
        ...
        <div class="Next">
        <button><a href="/level1/readD">Lanjut!!!</a></button>
        </div>
    </div>
